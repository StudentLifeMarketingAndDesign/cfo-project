<?php 
SiteTree::add_extension('Page', 'CfoPage');
ContentController::add_extension('Page_Controller', 'CfoPage_Controller');
...
SS_Object::add_extension("BlogEntry","BlogFieldExtension");
SS_Object::add_extension("BlogPost","BlogFieldExtension");
SS_Object::add_extension("Page","WidgetExtension");
